...
define("APP_GAMEMODULE_PATH", "./railbaron/misc/"); // include path to mocks, this defined "Table" and other classes

use PHPUnit\Framework\TestCase;

final class RailbaronTest extends TestCase
{
	private static $his;
	...
	{
		$this->assertInstanceOf(RailbaronMocker::class, self::$his);
	}
